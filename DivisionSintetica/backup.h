...
protected:
	...
	void GetDialogTemplate(DLGTEMPLATE& dlgTemplate)
	{
		...
		dlgTemplate.cy = Sys::Convert::PixelToDlgUnitY(130);
	...
	void InitializeGui()
	{
		...
		tbx3.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT | ES_WINNORMALCASE, 10, 95, 306, 28, hWnd, 1005);
